        ...
        <div class="container-xxl flex-grow-1 container-p-y">
            <div class="row mb-4">
                ...
                <div class="col-md mb-4 mb-md-0">
                    <a href="/admin/titik_kumpul/create" class="btn btn-primary mb-3">Tambah Lokasi Titik Kumpul</a>
                    <div class="card">
                        <h5 class="card-header">Data Lokasi Titik Kumpul</h5>
                        <div class="card-body">
...
@push('js')
    <script>
        ...
        async function updateStatus(id, e) {
            e.preventDefault();
            var param = {
                url: '/admin/titik_kumpul/update_status/' + id,
                method: 'PUT',
                data: "status",
                processData: false,
                contentType: false,
