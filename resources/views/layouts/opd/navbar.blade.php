...
<nav class="navbar navbar-expand-lg main-navbar container">
  <ul class="navbar-nav navbar-right ml-auto">
      ...
      <img alt="image" src="{{ asset('storage/pegawai/img/profile/'. auth()->guard('opd')->user()->image) }}" class="rounded-circle mr-1">
      <div class="d-sm-none d-lg-inline-block">Hi, {{ auth()->guard('opd')->user()->name }}</div></a>
